	...
	<div class="container mt-5 d-flex">
		<section class="w-75 ps-5">
			...
			<table class="table">
				...
				<c:forEach var="pDto" items="${requestScope.pDtos}">
					<tr>
						...
						<td>
							<image src="${ctx}/uploadedFile/${pDto.pImage}" width="80px"/>
						</td>
						<td>${pDto.pName}</td>
						<td>${pDto.pQty} 개</td>
						<td>${pDto.price} 원</td>
					...
					<tr>
						<form action = "cartDelete2.do" name="cartForm" method="post">
			...
			<div class="text-center" style="color:green; font-weight:bold;">
				장바구니 총 가격 : <fmt:formatNumber type="Number" value="${cartTotPrice}"/>원<br/>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<label for="use">
								모두사용 [<b><fmt:formatNumber type="number" value="${cartTotPoint}"/></b>원]
							</label>
						</td>
					</tr>
