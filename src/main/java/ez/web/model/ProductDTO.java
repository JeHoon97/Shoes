...
public class ProductDTO {
	...
	public ProductDTO(int pNum, String pName, String pCategory_fk, String pCompany, String pImage, int pQty,
			int price, String pSpec, String pContent, int pPoint, String pInputDate, int totPoint,
			int salePrice) {
		super();
		this.pNum = pNum;
		this.pName = pName;
	...
	public String toString() {
		return "ProductDTO [pNum=" + pNum + ", pName=" + pName + ", pCategory_fk=" + pCategory_fk + ", pCompany="
				...
				+ totPrice + ", totPoint=" + totPoint + ", salePrice=" + salePrice + "]";
	}
